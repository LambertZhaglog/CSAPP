...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, ILEAVE, IIADDL }; #had added the leave, iaddl

# Does fetched instruction require a regid byte?
bool need_regids =
	icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL }; #add iaddl

# Does fetched instruction require a constant word?
bool need_valC =
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL }; #add iaddl
...
int srcA = [
	...
	icode in { ILEAVE } : REBP; #add for leave
	1 : RNONE; # Don't need register
];

## What register should be used as the B source?
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL  } : rB;#add iaddl
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL } : rB;# add iaddl
	icode in { IPUSHL, IPOPL, ICALL, IRET,ILEAVE } : RESP; #add leave
...
int aluA = [
	icode in { IRRMOVL, IOPL,ILEAVE } : valA;# add leave
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL } : valC;# add iaddl
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL } : valB;# add iaddl
	icode in { IRRMOVL, IIRMOVL } : 0;
	icode in { ILEAVE }: 4; # add for leave
	# Other instructions don't need ALU
];
...
bool set_cc = icode in { IOPL, IIADDL }; # add iaddl

################ Memory Stage    ###################################

## Set read control signal
bool mem_read = icode in { IMRMOVL, IPOPL, IRET, ILEAVE }; # add leave
...
int mem_addr = [
	...
	icode in { IPOPL, IRET, ILEAVE } : valA; # add leave
